...
object Person {
  ...
  case class Greet(person: ActorRef) extends PersonProtocol
  case object Hello extends PersonProtocol
  case object WhatsYourName extends PersonProtocol
  case class NameReply(name: String) extends PersonProtocol
